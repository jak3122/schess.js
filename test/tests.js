...
describe.only("Single Square Move Generation", function () {
...
describe("Get/Put/Remove", function () {
    ...
    var positions = [
        {
            pieces: {
                a7: { type: game.PAWN, color: game.WHITE },
        ...
        {
            pieces: {
                a7: { type: game.KING, color: game.BLACK },
                h2: { type: game.KING, color: game.WHITE },
                h2: { type: game.KING, color: game.WHITE }
            },
            should_pass: true
    ...
    tests.forEach(function (t, i) {
        newline_chars.forEach(function (newline, j) {
            it(i + String.fromCharCode(97 + j), function () {
                ...
                var result = game.load_pgn(t.pgn.join(newline), {
                    sloppy: sloppy,
